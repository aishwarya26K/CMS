    ...
    <table class="table table-bordered table-hover">
        ...
        <tbody>
            ...
            while ($row = mysqli_fetch_assoc($select_posts_query)) {
                ...
                $query = "SELECT count(comment_id) as comments_published from comments WHERE comment_post_id={$post_id} and comment_status='approved' group by comment_post_id";
                $res = mysqli_fetch_assoc(mysqli_query($conn, $query));
                $post_comment_count = $res ? $res['comments_published'] : 0 ;
                echo "<tr>";
            ?>
                <td>
